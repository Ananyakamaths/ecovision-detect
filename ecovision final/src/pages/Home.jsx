    ...
    <div>
      ...
      <section id="about" className="page-section">
        ...
        <p>
          ...
          organic, e-waste, hazardous, and non-recyclable — making smart disposal accessible to everyone.
        </p>
      </section>
      ...
      <section className="page-section">
        ...
        <p>
          ...
          Based on classification, a reusability and recyclability score is generated instantly.
        </p>
      </section>
      ...
      <section id="team" className="page-section">
        <h2>Team</h2>
        <p className="team-member-name">Ananya kamath s</p>
      </section>
    </div>
  );
}
